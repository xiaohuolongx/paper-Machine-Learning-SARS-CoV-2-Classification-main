...
data_cfg = dict(
    ...
    train = dict(
        ...
        pretrained_weights = 'pre-learning-data/mobilenet_v3_small-8427ecf0.pth',
        freeze_flag = False,
        freeze_layers = ('backbone',),
        epoches = 10,
    ),
    test=dict(
        ckpt = 'H:/论文所用程序\paper-Machine Learning-SARS-CoV-2-Classification-main/logs/MobileNetV3/2026-03-31-22-07-07/Val_Epoch008-Acc96.094.pth',
