...
- 确认`paper-Machine Learning-SARS-CoV-2-Classification-main/datas/`下`train.txt`与`test.txt`与`annotations.txt`对应
- 选择想要训练的模型，在`paper-Machine Learning-SARS-CoV-2-Classification-main/models/`下找到对应配置文件
- 按照`配置文件解释`修改参数
